                    ...
                    if (section != null) {
                        ...
                        if (sell_list.contains(getMaterialData())) {
                            ...
                            if (worth > 0) {
                                ...
                                com.hongminh54.storage.Utils.StatsManager.recordSell(p, this.amount);
                ...
                if (section != null) {
                    ...
                    if (sell_list.contains(getMaterialData())) {
                        ...
                        if (worth > 0) {
                            ...
                            // Ghi nhận thống kê bán tất cả
                            com.hongminh54.storage.Utils.StatsManager.recordSell(p, amount);
