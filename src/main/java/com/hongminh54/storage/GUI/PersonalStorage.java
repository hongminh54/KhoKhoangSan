...
public class PersonalStorage implements IGUI {
    ...
    public Inventory getInventory() {
        Inventory inventory = Bukkit.createInventory(p, config.getInt("size") * 9, com.hongminh54.storage.Utils.GUIText.format(Objects.requireNonNull(config.getString("title")).replace("#player#", p.getName())));
